...
\gtrDeclareDatabaseFormat{full-ages}{}{%
    ...
    \begin{gtreventlist}%
        ...
        \gtr@list@event{marriage}\pgfkeysifdefined{/gtr/database/save/marriageage}{ (\pgfkeysvalueof{/gtr/database/save/marriageage})}{}%
        \gtr@list@event{divorce}%
        \gtr@list@event{floruit}%
        \gtr@list@event{death}\pgfkeysifdefined{/gtr/database/save/deathage}{ (\pgfkeysvalueof{/gtr/database/save/deathage})}{}%
